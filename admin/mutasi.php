...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main">
         <div class="">
            <div class="page-title">
                ...
                <h3> Data Mutasi Pegawai Bapelkes Provinsi Lampung</h3>
                 <ol class="breadcrumb">
	  ...
	  <br>
       <br> <p><a href="tambahmutasi1.php"><button class="btn btn-info" >Tambah Mutasi Pegawai<a href="tambahmutasi1.php"></button></a>   
	  	<p><a href="cetakmutasi.php"><button class="btn btn-default">Cetak Laporan Mutasi<a href="cetakmutasi.php"></button></a></p>
