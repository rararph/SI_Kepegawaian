...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body">
	  ...
	  <br>
       <br> <p><a href="tambahpegawai.php"><button class="btn btn-info" >Tambah Data <a href="tambahpegawai.php"></button></a></p> </br>
		<p><a href="cetakpegawai.php"><button class="btn btn-default">Cetak Data Pegawai<a href="cetakpegawai.php"></button></a></p>
    ...
    if(mysql_num_rows($query) == 0){  //ini artinya jika data hasil query di atas kosong
      ...
      while($data = mysql_fetch_assoc($query)){ //perulangan while dg membuat variabel $data yang akan mengambil data di database
        ...
        echo '<td><center> <a href="editpegawai.php?nip='.$data['nip'].'"><button type="button" class="btn btn-warning btn-circle"><i class="fa fa-pencil"></i></button></a>  <a href="detail.php?nip='.$data['nip'].'"><button type="button" class="btn btn-blue btn-circle"><i class="fa fa-eye"></i></button></a>  <a href="hapuspegawai.php?id='.$data['nip'].'" onclick="return confirm(\'Yakin Ingin Menghapusnya?\')"> <button type="button" class="btn btn-danger btn-circle"><i class="fa fa-trash-o"></i></button></a></i></button></a></td>' ; //menampilkan link edit dan hapus dimana tiap link terdapat GET id -> ?nip=nip
	   echo '</tr>';
