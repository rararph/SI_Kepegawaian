        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
               <img src="../admin/images/logo.png" width="70" height="55" style="float:left"/><a class="navbar-brand" href="index.php">SIMPEG</a>
            </div>
    ...
    if(mysql_num_rows($query) == 0){  //ini artinya jika data hasil query di atas kosong
      ...
      while($data = mysql_fetch_assoc($query)){ //perulangan while dg membuat variabel $data yang akan mengambil data di database
        ...
        echo '<tr>';
		  ...
		  echo '<td>'.$data['alamattinggal'].'</td>';
		  echo '<td>'.$data['alamatasal'].'</td>';
        echo '<td><center><a href="editprofilepegawai.php?id='.$data['id_pegawai'].'"><button type="button" class="btn btn-warning btn-circle"><i class="fa fa-pencil"></i></button></a>  <a href="hapusprofilepegawai.php?id='.$data['id_pegawai'].'" onclick="return confirm(\'Yakin Ingin Menghapusnya?\')"> <button type="button" class="btn btn-danger btn-circle"><i class="fa fa-trash-o"></i></button></a></i></button></a></td>' ; //menampilkan link edit dan hapus dimana tiap link terdapat GET id -> ?id=nip
	   echo '</tr>';
